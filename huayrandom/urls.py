...
#  set = huay_name / เลข 2 วิ่งรูด / เลข เจาะ
    path('backend/huay_type/hub/edit/<str:username>/<int:huay_id>', HubForEditHuayType,name="hub_edit_huay_type"),
    path('backend/huay_name/font_family/<str:username>/<int:huay_id>/<str:text_font>', SetAllHuayNameFontFamily,name="set_all_huay_name_font_family"),
    path('backend/huay_name/font_color/<str:username>/<int:huay_id>/<str:text_color>', SetAllHuayNameFontColor,name="set_all_huay_name_font_color"),
    path('backend/huay_name/font_size/<str:username>/<int:huay_id>/<str:text_size>', SetAllHuayNameFontSize,name="set_all_huay_name_font_size"),
    path('backend/huay_name/pos/<str:username>/<int:huay_id>/<int:text_pos_x>/<int:text_pos_y>', SetAllHuayNamePos,name="set_all_huay_name_pos"),
    path('backend/huay_name/pos/<str:username>/<int:huay_id>/<str:text_border_status>/<int:text_border_size>/<int:text_border_color>', SetAllHuayNameBorder,name="set_all_huay_name_border"),
