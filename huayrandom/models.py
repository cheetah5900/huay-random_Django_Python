...
class HuayTypeModel(models.Model):
    ...
    border_size = models.IntegerField(default=4)
    border_color = models.IntegerField(default=2)
    border_status = models.CharField(default='on', max_length=25)
    ...
    date_color = models.IntegerField(default=1)
    ...
    main_num_color = models.IntegerField(default=1)
    ...
    focus_num_color = models.IntegerField(default=1)
    ...
    row1_separator = models.CharField(default=' - ', max_length=255)
    row2_separator = models.CharField(default=' - ', max_length=255)
